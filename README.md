...
The project focuses on BI and data analytics solution using a real-world customer feedback dataset ([Customer Sentiment Dataset on Kaggle](https://www.kaggle.com/datasets/kundanbedmutha/customer-sentiment-dataset)). The primary goal is to apply data science and Natural Language Processing (NLP) techniques to extract actionable business insights.
